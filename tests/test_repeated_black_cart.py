...
class TestRepeatedBlackCart:
    
    def setup_method(self):
        # 创建截图目录
        self.screenshot_dir = "screenshots_black"
    ...
    def test_repeated_add_black_to_cart(self, page: Page):
        # 执行5次测试
        total_tests = 5
        success_count = 0
        ...
        for test_num in range(1, total_tests + 1):
            ...
            try:
                ...
                for i in range(cart_items.count()):
                    ...
                    if "SPECIAL" in item_name:
                        cart_has_special_product = True
                        break
                
                assert cart_has_special_product, "购物车中没有包含'SPECIAL'的商品"
...
<body>
    <div class="container">
        ...
        for result in self.test_results:
            ...
            # 修复路径：从reports目录访问根目录的screenshots_black文件夹
            relative_path = "../" + result['screenshot_path']
            screenshot_link = f"<a href='{relative_path}' target='_blank'>查看截图</a>"
            html_content += '''
            <tr>
        ...
        # 保存HTML报告
        report_path = "reports/repeated_black_cart_report.html"
